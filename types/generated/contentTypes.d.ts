...
export interface ApiLandingImageLandingImage extends Schema.SingleType {
  ...
  info: {
    singularName: 'landing-image';
    pluralName: 'landing-images';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::landing-image.landing-image',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiMediaPhotoMediaPhoto extends Schema.SingleType {
  collectionName: 'media_photos';
  info: {
    singularName: 'media-photo';
    pluralName: 'media-photos';
...
export interface ApiMediaSongMediaSong extends Schema.CollectionType {
  collectionName: 'media_songs';
  info: {
    singularName: 'media-song';
    pluralName: 'media-songs';
    displayName: 'media-song';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::media-song.media-song': ApiMediaSongMediaSong;
